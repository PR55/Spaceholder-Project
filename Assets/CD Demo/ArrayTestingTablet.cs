...
public class ArrayTestingTablet : MonoBehaviour
{
    ...
    public void transferTablet(AudioClip[] audioClips, int Index, float[] frequencies)
    {
        playlistReal = audioClips;
        index = Index;
        songFrequencyAmounts = frequencies;
