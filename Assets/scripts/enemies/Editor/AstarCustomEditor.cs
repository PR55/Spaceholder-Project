...
[CustomEditor(typeof(AstarCustom))]
public class AstarCustomEditor : EditorBase
{
	...
	protected override void Inspector()
	{
		...
		PropertyField("angle");
		PropertyField("sightTimer");

		Section("Layer Masks Sight");
		PropertyField("targetMask");
		PropertyField("obstructionMask");
