...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    public abstract class ContinuousMoveProviderBaseLocal : LocomotionProvider
    {
        /// <summary>
        ...
        public bool customGravityActive = true;
        [SerializeField]
        ...
        protected virtual Vector3 ComputeDesiredMove(Vector2 input)
        {
            ...
            var translationInRigSpace = forwardRotation * inputMove * (m_MoveSpeed * Time.fixedDeltaTime);
